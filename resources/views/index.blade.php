                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                ...
                                <span class="post__comments">
                                    ...
                                    {{--{{substr($first_post->contents,0,10)}}--}}
                                    {{--{!! substr($first_post->contents,0,10) !!}--}}
                        ...
                        <div class="offers">
                            <div class="row">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                    <div class="heading">
                                        <h4 class="h1 heading-title">{{$sports->name}}</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="case-item-wrap">
                                    @foreach($sports->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                    ...
                    <div class="offers">
                      @if($education)
                            <div class="row">
                                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                    <div class="heading">
                                        <h4 class="h1 heading-title">{{$education->name}}</h4>
                                        <div class="heading-line">
                                            <span class="short-line"></span>
                                            <span class="long-line"></span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="case-item-wrap">
                                    @foreach($education->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                            <div class="case-item">
                                                <a href="{{route('post.single',['slug'=>$post->slug])}}">
                                                    <div class="case-item__thumb">
...
<script type="text/javascript">
    @if(Session::has('suscribed'))
        toastr.success("{{Session::get('suscribed')}}");
    @endif
